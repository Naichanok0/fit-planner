...
export function BodyAnalysis({ onAnalysisComplete, userGoal, fitnessLevel }: BodyAnalysisProps) {
            ...
            {analysisSteps.map((step, index) => (
              <div key={step.id} className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  step.completed ? 'bg-green-100 text-green-600 dark:bg-green-900/20' : 'bg-gray-100 text-gray-400 dark:bg-gray-800'
                }`}>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              {cameraActive ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center">
                    ...
                    <h3 className="font-semibold mb-2">Use Camera</h3>
                    <p className="text-sm text-muted-foreground mb-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                <h4 className="font-semibold mb-2 text-blue-900 dark:text-blue-100">Photo Tips for Best Results:</h4>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-primary">{analysisResults.bmi.toFixed(1)}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-primary">{analysisResults.bodyFatPercentage.toFixed(1)}%</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-primary">{analysisResults.muscleMass.toFixed(1)}kg</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-primary">{analysisResults.bodyType}</div>
