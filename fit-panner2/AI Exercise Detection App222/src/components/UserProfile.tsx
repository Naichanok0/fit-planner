...
export function UserProfile({ userData, onUpdateProfile, onSecurityUpdate }: UserProfileProps) {
  ...
  const getFitnessLevelText = (level: string) => {
    switch (level) {
      case 'beginner': return t('personalProgram.beginner');
      case 'intermediate': return t('personalProgram.intermediate');
      case 'advanced': return t('personalProgram.advanced');
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="beginner">{t('personalProgram.beginner')}</SelectItem>
                      <SelectItem value="intermediate">{t('personalProgram.intermediate')}</SelectItem>
                      <SelectItem value="advanced">{t('personalProgram.advanced')}</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
