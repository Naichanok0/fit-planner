...
export default function Home() {
  ...
  // mock data (จริง ๆ จะ fetch จาก backend)
    ...
    <SafeAreaView style={styles.screen} edges={['top', 'left', 'right']}>
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: 90 + insets.bottom }]}>
        ...
        <ThemedView style={styles.headerRow}>
          <ThemedText type="title" style={styles.appTitle}>FITNESS APP</ThemedText>
        ...
        <ThemedView style={styles.analysisBox}>
          ...
          <Info label="Body Fat" value={metrics.body} />
        </ThemedView>
...
const styles = StyleSheet.create({
  ...
  appTitle: { letterSpacing: 1, fontSize: 18, fontWeight: '700' },
  menuBtn: { padding: 8 },
