...
export function ProgressDashboard({ totalReps, currentStreak, formFeedback }: ProgressDashboardProps) {
  const achievements = [
    { id: 1, title: 'First Steps', description: 'Completed your first workout', unlocked: true },
    { id: 2, title: 'Consistency King', description: '7-day workout streak', unlocked: currentStreak >= 7 },
    { id: 3, title: 'Century Club', description: '100 total reps', unlocked: totalReps >= 100 },
    { id: 4, title: 'Form Master', description: 'Maintain 90%+ form score', unlocked: false },
    { id: 5, title: 'Marathon Runner', description: '30-day workout streak', unlocked: false }
  ];
